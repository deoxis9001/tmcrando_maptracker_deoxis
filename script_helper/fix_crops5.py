...
_DUNGEON_ALL_POSITIONS = [
    ...
    ("map_clouds",      1980, 128),     # pos 2 : POW  (2304, 245)   → recalc quand crop mis à jour
...
OVERRIDES = {
    ...
    "Dungeons.json": {
        ...
        "Palace Entrance":            [("map_clouds",      1980, 128)],   # recalc quand crop mis à jour
    ...
    "Hylia.json": {
        ...
        "Hylia - Cape Cave - Lon Lon": [
            ("map_lonlon", 1661, 799),          # x=2017-1661=356, y=878-799=79
        ],
    ...
    "Clouds.json": {
        # pos 1 (x=2305, y=360) → map_clouds  (mettre à jour le crop clouds pour inclure x=2305)
        # pos 2 (x=1379, y=1826) → map_southfield
        "Wind Tribe": [
            ("map_clouds", 1980, 128),            # recalculer après update du crop clouds
