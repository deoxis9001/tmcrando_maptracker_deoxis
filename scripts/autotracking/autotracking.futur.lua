...
function updateLocations(segment)
  ...
  if AUTOTRACKER_ENABLE_FUZER_TRACKING then
		...
		updateFusion(segment, "fusions43", 0x2002c89, 0x08)--GreenG
		updateFusion(segment, "fusions44", 0x2002c89, 0x10)--GreenG
		updateFusion(segment, "fusions45", 0x2002c89, 0x20)--GreenG
		updateFusion(segment, "fusions46", 0x2002c89, 0x40)--GreenG
		updateFusion(segment, "fusions47", 0x2002c89, 0x80)--GreenG
		updateFusion(segment, "fusions48", 0x2002c8a, 0x01)--GreenG
		updateFusion(segment, "fusions49", 0x2002c8a, 0x02)--GreenG
		updateFusion(segment, "fusions4a", 0x2002c8a, 0x04)--GreenG
		updateFusion(segment, "fusions4b", 0x2002c8a, 0x08)--GreenG
		updateFusion(segment, "fusions4c", 0x2002c8a, 0x10)--GreenG
		updateFusion(segment, "fusions4d", 0x2002c8a, 0x20)--GreenG
		updateFusion(segment, "fusions4e", 0x2002c8a, 0x40)--GreenG
		
		updateFusion(segment, "fusions4f", 0x2002c8a, 0x80)--GreenP
		updateFusion(segment, "fusions50", 0x2002c8b, 0x01)--GreenP
		updateFusion(segment, "fusions51", 0x2002c8b, 0x02)--GreenP
		updateFusion(segment, "fusions52", 0x2002c8b, 0x04)--GreenP
		updateFusion(segment, "fusions53", 0x2002c8b, 0x08)--GreenP
		updateFusion(segment, "fusions54", 0x2002c8b, 0x10)--GreenP
		updateFusion(segment, "fusions55", 0x2002c8b, 0x20)--GreenP
		updateFusion(segment, "fusions56", 0x2002c8b, 0x40)--GreenP
		updateFusion(segment, "fusions57", 0x2002c8b, 0x80)--GreenP
		updateFusion(segment, "fusions58", 0x2002c8c, 0x01)--GreenP
		updateFusion(segment, "fusions59", 0x2002c8c, 0x02)--GreenP
		updateFusion(segment, "fusions5a", 0x2002c8c, 0x04)--GreenP
		updateFusion(segment, "fusions5b", 0x2002c8c, 0x08)--GreenP
		
		updateFusion("GreenC",segment, "fusions5c", 0x2002c8c, 0x10)--GreenC
		
		updateFusion(segment, "fusions5d", 0x2002c8c, 0x20)--GreenG
		updateFusion(segment, "fusions5e", 0x2002c8c, 0x40)--GreenP
		updateFusion("GreenC",segment, "fusions5f", 0x2002c8c, 0x80)--GreenC
		updateFusion(segment, "fusions60", 0x2002c8d, 0x01)--GreenG
		updateFusion(segment, "fusions61", 0x2002c8d, 0x02)--GreenP
		updateFusion(segment, "fusions62", 0x2002c8d, 0x04)--GreenG
		updateFusion(segment, "fusions63", 0x2002c8d, 0x08)--GreenG
		updateFusion(segment, "fusions64", 0x2002c8d, 0x10)--GreenP
  end
  if AUTOTRACKER_ENABLE_LOCATION_TRACKING then
	  --GOLDEN
