...
function updateLocations(segment)
  ...
  if AUTOTRACKER_ENABLE_FUZER_TRACKING then
		...
		updateFusion("GreenC",segment, "fusions36", 0x2002c87, 0x40)--GreenC
		updateFusion("GreenC",segment, "fusions37", 0x2002c87, 0x80)--GreenC
		updateFusion("GreenC",segment, "fusions38", 0x2002c88, 0x01)--GreenC
		updateFusion("GreenC",segment, "fusions39", 0x2002c88, 0x02)--GreenC
		updateFusion("GreenC",segment, "fusions3a", 0x2002c88, 0x04)--GreenC
		updateFusion("GreenC",segment, "fusions3b", 0x2002c88, 0x08)--GreenC
		updateFusion("GreenC",segment, "fusions3c", 0x2002c88, 0x10)--GreenC
		updateFusion("GreenC",segment, "fusions3d", 0x2002c88, 0x20)--GreenC
		updateFusion("GreenC",segment, "fusions3e", 0x2002c88, 0x40)--GreenC
		updateFusion("GreenC",segment, "fusions3f", 0x2002c88, 0x80)--GreenC
		updateFusion("GreenC",segment, "fusions40", 0x2002c89, 0x01)--GreenC
		updateFusion("GreenC",segment, "fusions41", 0x2002c89, 0x02)--GreenC
		updateFusion("GreenC",segment, "fusions42", 0x2002c89, 0x04)--GreenC
		
		updateFusion("GreenG",segment, "fusions43", 0x2002c89, 0x08)--GreenG
		updateFusion("GreenG",segment, "fusions44", 0x2002c89, 0x10)--GreenG
		updateFusion("GreenG",segment, "fusions45", 0x2002c89, 0x20)--GreenG
		updateFusion("GreenG",segment, "fusions46", 0x2002c89, 0x40)--GreenG
		updateFusion("GreenG",segment, "fusions47", 0x2002c89, 0x80)--GreenG
		updateFusion("GreenG",segment, "fusions48", 0x2002c8a, 0x01)--GreenG
		updateFusion("GreenG",segment, "fusions49", 0x2002c8a, 0x02)--GreenG
		updateFusion("GreenG",segment, "fusions4a", 0x2002c8a, 0x04)--GreenG
		updateFusion("GreenG",segment, "fusions4b", 0x2002c8a, 0x08)--GreenG
		updateFusion("GreenG",segment, "fusions4c", 0x2002c8a, 0x10)--GreenG
		updateFusion("GreenG",segment, "fusions4d", 0x2002c8a, 0x20)--GreenG
		updateFusion("GreenG",segment, "fusions4e", 0x2002c8a, 0x40)--GreenG
		
		updateFusion("GreenP",segment, "fusions4f", 0x2002c8a, 0x80)--GreenP
		updateFusion("GreenP",segment, "fusions50", 0x2002c8b, 0x01)--GreenP
		updateFusion("GreenP",segment, "fusions51", 0x2002c8b, 0x02)--GreenP
		updateFusion("GreenP",segment, "fusions52", 0x2002c8b, 0x04)--GreenP
		updateFusion("GreenP",segment, "fusions53", 0x2002c8b, 0x08)--GreenP
		updateFusion("GreenP",segment, "fusions54", 0x2002c8b, 0x10)--GreenP
		updateFusion("GreenP",segment, "fusions55", 0x2002c8b, 0x20)--GreenP
		updateFusion("GreenP",segment, "fusions56", 0x2002c8b, 0x40)--GreenP
		updateFusion("GreenP",segment, "fusions57", 0x2002c8b, 0x80)--GreenP
		updateFusion("GreenP",segment, "fusions58", 0x2002c8c, 0x01)--GreenP
		updateFusion("GreenP",segment, "fusions59", 0x2002c8c, 0x02)--GreenP
		updateFusion("GreenP",segment, "fusions5a", 0x2002c8c, 0x04)--GreenP
		updateFusion("GreenP",segment, "fusions5b", 0x2002c8c, 0x08)--GreenP
		
		updateFusion("GreenC",segment, "fusions5c", 0x2002c8c, 0x10)--GreenC
		
		updateFusion("GreenG",segment, "fusions5d", 0x2002c8c, 0x20)--GreenG
		updateFusion("GreenP",segment, "fusions5e", 0x2002c8c, 0x40)--GreenP
		updateFusion("GreenC",segment, "fusions5f", 0x2002c8c, 0x80)--GreenC
		updateFusion("GreenG",segment, "fusions60", 0x2002c8d, 0x01)--GreenG
		updateFusion("GreenP",segment, "fusions61", 0x2002c8d, 0x02)--GreenP
		updateFusion("GreenG",segment, "fusions62", 0x2002c8d, 0x04)--GreenG
		updateFusion("GreenG",segment, "fusions63", 0x2002c8d, 0x08)--GreenG
		updateFusion("GreenP",segment, "fusions64", 0x2002c8d, 0x10)--GreenP
  end
  if AUTOTRACKER_ENABLE_LOCATION_TRACKING then
	  --GOLDEN
	  ...
	  updateDecreaseCount(segment, "@Castor Wilds - Fusions/Fusions", {{0x2002c81, 0x40},{0x2002c81,0x80},{0x2002c82,0x01}})
	  ...
	  updateDecreaseCount(segment, "@Crenel - Mines/Digging", {{0x2002cf3,0x02},{0x2002cf3,0x04},{0x2002cf3,0x08},{0x2002cf3,0x10},{0x2002cf3,0x20},{0x2002cf3,0x40},{0x2002cf3,0x80},{0x2002cf4,0x01}})
	  ...
	  updateDecreaseCount(segment, "@Crenel - Beanstalk/Rupees", {{0x2002d0e,0x40},{0x2002d0e,0x80},{0x2002d0f,0x01},{0x2002d0f,0x02},{0x2002d0f,0x04},{0x2002d0f,0x08},{0x2002d0f,0x10},{0x2002d0f,0x20}})
	  ...
	  updateDecreaseCount(segment, "@Trilby Highlands - Rupee Cave/Rupees",{{0x2002d20,0x10},{0x2002d20,0x20},{0x2002d20,0x40},{0x2002d20,0x80},{0x2002d21,0x01},{0x2002d21,0x02},{0x2002d21,0x04},{0x2002d21,0x08},{0x2002d21,0x10},{0x2002d21,0x20},{0x2002d21,0x40},{0x2002d21,0x80},{0x2002d22,0x01},{0x2002d22,0x02},{0x2002d22,0x04}})

	  --WESTERN WOOD
	  updateDecreaseCount(segment, "@Western Woods - North Digging Spots/Buried Treasure", {{0x2002cce,0x08},{0x2002cce,0x10},{0x2002cce,0x20},{0x2002cce,0x40},{0x2002cce,0x80},{0x2002ccf,0x01}})
	  updateDecreaseCount(segment, "@Western Woods - South Digging Spots/Buried Treasure", {{0x2002ccf, 0x02},{0x2002ccf,0x04}})
	  ...
	  updateDecreaseCount(segment, "@Western Woods - Beanstalk/Rupees",{{0x2002d0d,0x10},{0x2002d0d,0x20},{0x2002d0d,0x40},{0x2002d0d,0x80},{0x2002d0e,0x01},{0x2002d0e,0x02},{0x2002d0e,0x04},{0x2002d0e,0x08},{0x2002d0f,0x40},{0x2002d0f,0x80},{0x2002d10,0x01},{0x2002d10,0x02},{0x2002d10,0x04},{0x2002d10,0x08},{0x2002d10,0x10},{0x2002d10,0x20}})
	  ...
	  updateDecreaseCount(segment, "@Town - Eastern Shops/Figurine House", {{0x2002cf2, 0x20},{0x2002cf2,0x40},{0x2002cf2,0x80}})
	  ...
	  updateDecreaseCount(segment, "@Town - School Gardens/Garden Chests",{{0x2002d0b,80},{0x2002d0c,0x01},{0x2002d0c,0x02}})
	  ...
	  updateDecreaseCount(segment,"@South Field - Rupee Cave/Rupees", {{0x2002d1e,0x20},{0x2002d1e,0x40},{0x2002d1e,0x80},{0x2002d1f,0x01},{0x2002d1f,0x02},{0x2002d1f,0x04},{0x2002d1f,0x08},{0x2002d1f,0x10},{0x2002d1f,0x20},{0x2002d1f,0x40},{0x2002d1f,0x80},{0x2002d20,0x01},{0x2002d20,0x02},{0x2002d20,0x04},{0x2002d20,0x08}})
	  ...
	  updateDecreaseCount(segment, "@Veil Falls - Upper Cave/Downstairs Rupees", {{0x2002d25,0x20},{0x2002d25,0x40},{0x2002d25,0x80},{0x2002d26,0x01},{0x2002d26,0x02},{0x2002d26,0x04},{0x2002d26,0x08},{0x2002d26,0x10},{0x2002d26,0x20}})
	  updateDecreaseCount(segment, "@Veil Falls - Upper Cave/Underwater Rupees", {{0x2002d26,0x40},{0x2002d26,0x80},{0x2002d27,0x01},{0x2002d27,0x02},{0x2002d27,0x04},{0x2002d27,0x08}})
	  ...
	  updateSectionFlag(segment, "@Veil Falls South - Mitts Cave/Right Chest", 0x2002d05, 0x10)--à verifier
	  ...
	  updateDecreaseCount(segment, "@Hylia - Treasure Cave/Chest", {{0x2002d02,0x80},{0x2002d03,0x02},{0x2002d03,0x04},{0x2002d03,0x08},{0x2002d03,0x10},{0x2002d03,0x20},{0x2002d03,0x40}})
	  ...
	  updateDecreaseCount(segment, "@Cave Of Flame/Rupees", {{0x2002d5b, 0x40},{0x2002d5b, 0x80},{0x2002d5c, 0x01},{0x2002d5c, 0x02},{0x2002d5c, 0x04}})
	  ...
	  updateDecreaseCount(segment, "@Fortress/Left Side Rupees",{{0x2002d06, 0x20},{0x2002d06,0x40},{0x2002d06,0x80},{0x2002d07,0x01},{0x2002d07,0x02},{0x2002d07,0x04}})
	  ...
	  updateDecreaseCount(segment, "@Fortress - Left Side Left Rupees/Rupees",{{0x2002d06, 0x20},{0x2002d06,0x40},{0x2002d06,0x80},{0x2002d07,0x01}})
	  ...
	  updateDecreaseCount(segment,"@Droplet/Left Path Rupees",{{0x2002d94,0x20},{0x2002d94,0x40},{0x2002d94,0x80},{0x2002d95,0x01},{0x2002d95,0x02}})
	  ...
	  updateDecreaseCount(segment, "@Droplet/Upper Water Rupees",{{0x2002d96,0x20},{0x2002d96,0x40},{0x2002d96,0x80},{0x2002d97,0x01},{0x2002d97,0x02},{0x2002d97,0x04}})
	  updateDecreaseCount(segment, "@Droplet/Lower Water Rupees",{{0x2002d95,0x80},{0x2002d96,0x01},{0x2002d96,0x02},{0x2002d96,0x04},{0x2002d96,0x08},{0x2002d96,0x10}})
	  ...
	  updateDecreaseCount(segment, "@Droplet - Right Path/Rupees", {{0x2002d95,0x10},{0x2002d95,0x20},{0x2002d95,0x40}})
	  updateDecreaseCount(segment, "@Droplet - Right Path/Rupees Grabbable", {{0x2002d95,0x04},{0x2002d95,0x08}})
	  updateDecreaseCount(segment, "@Droplet - Upper Underwater/Rupees",{{0x2002d96,0x20},{0x2002d96,0x40},{0x2002d96,0x80},{0x2002d97,0x01},{0x2002d97,0x02},{0x2002d97,0x04}})
      updateDecreaseCount(segment, "@Droplet - Lower Underwater/Rupees",{{0x2002d95,0x80},{0x2002d96,0x01},{0x2002d96,0x02},{0x2002d96,0x04},{0x2002d96,0x08},{0x2002d96,0x10}})
	  ...
	  updateDecreaseCount(segment, "@Palace/Rupees", {{0x2002da7, 0x04},{0x2002da7,0x08},{0x2002da7,0x10},{0x2002da7,0x20},{0x2002da7,0x40}})
	  ...
	  updateDecreaseCount(segment, "@Palace - Rupees/Rupees", {{0x2002da7, 0x04},{0x2002da7,0x08},{0x2002da7,0x10},{0x2002da7,0x20},{0x2002da7,0x40}})
