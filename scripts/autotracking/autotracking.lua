...
function updateLocations(segment)
  ...
  if AUTOTRACKER_ENABLE_LOCATION_TRACKING then
	  ...
	  updateSectionChestCountFromByteAndFlag(segment, "@Deepwoods - Two Lamp/Chest", 0x2002d40, 0x10)
	  updateSectionChestCountFromByteAndFlag(segment, "@Deepwoods - Basement Switch Room/Big Chest", 0x2002d44, 0x04)
	  updateSectionChestCountFromByteAndFlag(segment, "@Deepwoods - Basement Switch Room/Chest", 0x2002d44, 0x02)
	  updateSectionChestCountFromByteAndFlag(segment, "@Deepwoods - Blue Warp/Heart Piece", 0x2002d45, 0x80)
	  decreaseChestCount(segment, "@Deepwoods - Puffstool Room/Chest", {{0x2002d40, 0x04},{0x2002d40,0x08}})
	  updateSectionChestCountFromByteAndFlag(segment, "@Deepwoods - Madderpillar/Kill", 0x2002d3f, 0x08)
	  updateSectionChestCountFromByteAndFlag(segment, "@Deepwoods - Madderpillar/Heart Piece", 0x2002d46, 0x04)
	  ...
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Room Big Chest/Big Chest", 0x2002d59, 0x04)
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Big Chest Room/Chest", 0x2002d59, 0x02)
	  ...
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Bombable Wall/Heart Piece", 0x2002d5b, 0x10)
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Spiny Chu/Kill", 0x2002d57, 0x02)
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Spiny Chu/Pillar Chest", 0x2002d57, 0x01)
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Pre Lava Basement Room Block Chest/Chest", 0x2002d59, 0x10)
	  updateSectionChestCountFromByteAndFlag(segment, "@Cave Of Flame - Pre Lava Basement Room Ledge/Pre Lava Basement Room Ledge", 0x2002d59, 0x20)
	  ...
	  decreaseChestCount(segment, "@Fortress - Left Side Right Rupees/Rupees",{{0x2002d07,0x02},{0x2002d07,0x04},{0x2002d07,0x08}})
	  ...
	  updateSectionChestCountFromByteAndFlag(segment, "@Fortress - Center Path Switch/Switch", 0x2002d06, 0x02)
	  updateSectionChestCountFromByteAndFlag(segment, "@Fortress - Bombable Wall/Big Chest", 0x2002d08, 0x01)
	  updateSectionChestCountFromByteAndFlag(segment, "@Fortress - Bombable Wall/Chest", 0x2002d08, 0x02)
	  updateSectionChestCountFromByteAndFlag(segment, "@Fortress - Clone Puzzle Key/Drop", 0x2002d71, 0x40)
	  updateSectionChestCountFromByteAndFlag(segment, "@Fortress - Minish Dirt Room Key/Drop", 0x2002d08, 0x10)
	  ...
	  updateSectionChestCountFromByteAndFlag(segment, "@Palace - Wizzrobe Platform Fight/Big chest", 0x2002daa, 0x10)
	  ...
	  updateSectionChestCountFromByteAndFlag(segment, "@Palace - Pre Big Key Door/Big Chest", 0x2002da2, 0x10)
	  updateSectionChestCountFromByteAndFlag(segment, "@Palace - Roller/Chest", 0x2002da9, 0x80)
	  updateSectionChestCountFromByteAndFlag(segment, "@Palace - Dark Room/Big Chest", 0x2002dab, 0x02)
	  updateSectionChestCountFromByteAndFlag(segment, "@Palace - Dark Room/Chest", 0x2002dab, 0x04)
