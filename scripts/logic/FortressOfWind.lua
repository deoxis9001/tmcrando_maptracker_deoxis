function FoWLeftDoor() 
	...
	elseif ( has("small_key_none") ) then
		return 1
	elseif ( has("small_key_out_off") and Tracker:ProviderCountForCode("fow_smallkey") >= 1 ) then
		return 2
	else
		return 0
	end 
...
function FoWMiddleDoor() 
	...
	elseif ( has("small_key_none") ) then
		return 1
	elseif ( has("small_key_out_off") and Tracker:ProviderCountForCode("fow_smallkey") >= 2 ) then
		return 2
	else
		return 0
	end 
...
function FoWLastDoor() 
	...
	elseif ( Tracker:ProviderCountForCode("fow_smallkey") >= 3 and ( function_Cached("CanSplit2")==1 or function_Cached("CanSplit3")==1)) then
		return 1
	elseif ( has("small_key_out_off") and Tracker:ProviderCountForCode("fow_smallkey") >= 3 ) then
		return 2
	else
		return 0
	end 
