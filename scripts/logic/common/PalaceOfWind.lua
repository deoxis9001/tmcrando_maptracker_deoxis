...
function PoW2ndHalf1stDoor()
	if
		(Tracker:ProviderCountForCode("pow_smallkey") >= 4 and
			(function_Cached("PoWNoWarps") == 1 or function_Cached("PoWBlueWarp") == 1))
	 then
		return 1
	...
	elseif (has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 2) then
		return 2
	elseif
		(has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 1 and function_Cached("PoWBlueWarp") == 1)
	 then
		return 2
	else
		return 0
...
function PoWRedWarpDoor()
	...
	elseif (has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 3) then
		return 2
	elseif
		(has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 2 and function_Cached("PoWBlueWarp") == 1)
	 then
		return 2
	elseif
		(has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 1 and function_Cached("PoWRedWarp") == 1)
	 then
		return 2
	else
		return 0
...
function PoWLastDoor()
	...
	elseif (has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 4) then
		return 2
	elseif
		(has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 3 and function_Cached("PoWBlueWarp") == 1)
	 then
		return 2
	elseif
		(has("small_key_out_on") and Tracker:ProviderCountForCode("pow_smallkey") >= 2 and function_Cached("PoWRedWarp") == 1)
	 then
		return 2
	else
		return 0
