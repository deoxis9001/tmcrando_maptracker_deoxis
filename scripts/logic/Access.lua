...
function AccessTrilby() 
	if ( WesternShortcut_setting()==1 or has("flippers") or has("cape") or ( HasSword()==1 and HasSpin()==1 ) or GuardSkip()==1 or (CrenelWindCrest()==1 and (UpperBean()==1 or has("grip")))) then
		return 1
	else
		return 0
	end 
