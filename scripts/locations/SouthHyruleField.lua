...
function Json_SouthHyruleField_SmithsHouse_Chests()
  if function_Cached("Smith_House_Chest")==1 or function_Cached("Smith_Floor_Item1")==1 or function_Cached("Smith_Floor_Item2")==1 then
    return 1
  elseif function_Cached("Smith_House_Chest")==2 or function_Cached("Smith_Floor_Item1")==2 or function_Cached("Smith_Floor_Item2")==2 then
    return 1, AccessibilityLevel.SequenceBreak
  elseif function_Cached("Smith_House_Chest")==3 or function_Cached("Smith_Floor_Item1")==3 or function_Cached("Smith_Floor_Item2")==3 then
    return 1, AccessibilityLevel.Inspect
  else
    return 0
  end
