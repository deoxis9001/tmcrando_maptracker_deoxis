...
function updateLocations(segment)
	...
	if AUTOTRACKER_ENABLE_LOCATION_TRACKING then
		...
		updateSectionFlag(segment, "@Swamp - Underwater/Middle", 0x2002cc0, 0x08)
		updateSectionFlag(segment, "@Swamp - Underwater/Bottom", 0x2002cc0, 0x10)
		...
		updateSectionFlag(segment, "@Falls Lower - Dig Cave/Right Chest", 0x2002d05, 0x10)
		 --à verifier
		updateSectionFlag(segment, "@Falls Lower - Rock/Item 1", 0x2002cd0, 0x04)
		updateSectionFlag(segment, "@Falls Lower - Rock/Item 2", 0x2002cd0, 0x08)
		updateSectionFlag(segmemt, "@Falls Lower - Rock/Item 3", 0x2002cd0, 0x10)
		...
		updateSectionFlag(segment, "@Cave Of Flame/B1 - Hazy Room - Small Chest", 0x2002d59, 0x02)
		updateSectionFlag(segment, "@Cave Of Flame/B1 - Hazy Room - Big Chest", 0x2002d59, 0x04)
		updateSectionFlag(segment, "@Cave Of Flame/B1 - Rollobite - Chest", 0x2002d58, 0x80)
		updateSectionFlag(segment, "@Cave Of Flame/B1 - Rollobite - Pillar Chest", 0x2002d58, 0x40)
		...
		updateSectionFlag(segment, "@Fortress/Left 2F - Item Grabbable", 0x2002d07, 0x02)
		...
		updateSectionFlag(segment, "@Fortress/Right 2F - Chests", 0x2002d73, 0x20)
		updateSectionFlag(segment, "@Fortress/Left 3F - Switch - Chest", 0x2002d73, 0x40)
